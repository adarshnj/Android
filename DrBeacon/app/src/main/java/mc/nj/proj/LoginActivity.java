    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent stay = new Intent(getApplicationContext(), LoginActivity.class);
                startActivity(stay);
            }
        }
        ...
        public boolean loggingin() {
            try {
                String loginURL = HomeActivity.ipaddr+"/check_login";
                ...
                details.put("_id", mEmail);
                details.put("pwd", mPassword);
                ...
                if (json.getString("user_exists") == "true" && json.getString("password_match") == "true") {
                    return true;
                }
